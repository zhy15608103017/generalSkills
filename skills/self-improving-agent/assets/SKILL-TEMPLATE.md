...
description: "Use when concrete triggering conditions, symptoms, or requests match this skill."
---
...
---
name: skill-name-here
description: "Use when concrete triggering conditions or requests match this skill."
---
...
| Command | Purpose |
|---------|---------|
| `bash scripts/helper.sh` | [What it does] |
| `bash scripts/validate.sh` | [What it does] |
...
- **Description**: Start with `Use when` and mention concrete triggers
  - Good: "Use when Docker builds fail on Apple Silicon with platform mismatch errors."
  - Bad: "Docker stuff"
